...
5. **In Coolify** → Add repository URL with SSH format (git@github.com:borist-nababan-cloud/karuniastrapi.git)
...
3. **Configure Repository**:
   - **Repository URL**: Your GitHub repository URL (e.g., https://github.com/borist-nababan-cloud/karuniastrapi.git)
...
3. **Configure Repository**:
   ...
   - **Repository**: Select your repository (borist-nababan-cloud/karuniastrapi)
   - **Branch**: `main`
